...
Supplementary Table 5 provides plant-year evidence on U.S. coal-fired generation. Run these files in order:
...
| Supplementary Table 5 | `python/build_eia_state_controls_2001_2024.ipynb`; `python/build_eia_coal_generation_mechanism_2001_2024.ipynb`; `stata/eia_coal_generation_mechanism_regressions.do` |
| Supplementary Tables 6-10 | `R/cox_main.Rmd` |
| Supplementary Table 11 | `stata/aft_and_co2_emission.do` |
| Supplementary Table 12 | Author compilation from public sources |
| Supplementary Table 13 | `R/cox_main.Rmd` |
| Supplementary Table 14 | Author compilation from public sources |
